...
_NAME_ALIASES = {
    ...
    "زهاك":     ["زاهاك", "الضحاك", "النمرود", "نمرود"],
    "زاهاك":    ["الضحاك", "النمرود", "زهاك", "نمرود"],
    "الضحاك":   ["زاهاك", "النمرود", "زهاك"],
    "النمرود":  ["زاهاك", "الضحاك", "نمرود"],
    "نمرود":    ["النمرود", "زاهاك", "الضحاك"],
    "لوسيفر":   ["إبليس", "الشيطان", "سيربنت"],
    "إبليس":    ["لوسيفر", "الشيطان", "سيربنت"],
    "الشيطان":  ["لوسيفر", "إبليس"],
    "سميراميس": ["سميرامس", "زوجة النمرود"],
    "سيربنت":   ["الثعبان", "الأفعى", "إبليس"],
    "كاوي":     ["الحداد", "الثائر", "الحداد كاوي"],

    # Concept paraphrasing (most important for retrieval)
    "الملاكان اللذان علّما السحر":   ["هاروت وماروت"],
    "الملاكان اللذان علموا الناس":   ["هاروت وماروت"],
    "ملاكا السحر":                   ["هاروت وماروت"],
    "هاروت وماروت":                  ["الملاكان", "ملاكا السحر", "علّما السحر"],
    "النبي الذي حاول نمرود قتله":   ["إبراهيم"],
    "قتل والده":                     ["النمرود قتل أباه", "تمرد على والده"],
    "كيف مات النمرود":              ["البعوضة", "منخر النمرود"],
    "برج بابل":                      ["البرج", "برج النمرود"],
    "بابل":                          ["العراق", "بلاد الرافدين"],
}
